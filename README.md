...
[📦 MicroProfile Starter for Visual Studio Code](https://marketplace.visualstudio.com/items?itemName=MicroProfile-Community.mp-starter-vscode-ext) provides support for generating a MicroProfile Maven project based on the Eclipse MicroProfile starter project by the MicroProfile community.  You can quickly generate a project by choosing a MicroProfile version, server, and specifications such as CDI, Config, Health Check, Metrics, and more.
